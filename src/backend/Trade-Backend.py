...
from typing import Dict, Any, List, Optional, Tuple               import json
import time

load_dotenv(".env")
                                                                  app = Flask(__name__)

# CORS Configuration - Support all wallets                        CORS(app, resources={                                                 r"/api/*": {
        "origins": "*",
        "methods": ["GET", "POST", "OPTIONS"],
        "allow_headers": ["Content-Type", "Authorization", "X-Requested-With"],                                                             "expose_headers": ["Content-Type"],
